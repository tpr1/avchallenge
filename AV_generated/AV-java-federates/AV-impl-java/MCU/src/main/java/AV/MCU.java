...
public class MCU extends MCUBase {
  ...
  //  public boolean sendCondition = false;
    ...
    // J1931-71 compliant local Messages
     ...
     String Engine_Speed="0";         // pgn61444 SPN190
     String Engine_Temperature="0";   // pgn65262 SPN110
     String Motor_Power_Limits="0";   // pgn ?    SPN ?
     String Inverter_Temperature="0"; // pgn ?    SPN ? 
     
     // J1931-71 compliant external Messages
    
     
     
     String  VCU_Torque_Commands = "0";
     
     
    // Messages sent/received to/from actuators/sensors
     
     
     String Motor_Speed="0"; // see graph in slide 3
